...
//    throw new Error('fingerprint was the last attribute');
//  }
//
//  if ( packet.doc.attribute.messageIntegrity ) {
//    if ( name != ATTRIBUTE.fingerprint.NAME ) {
//      throw new Error('only fingerprint can follow message integrity');
//    }
//  }
//
//  switch ( name ) {
...
//        throw new Error('change request requires a binding request packet type');
//      }
//    } break;
//    case ATTRIBUTE.errorCode.NAME: {
//      if ( !(packet.doc.type.obj & 0x0010) ) {
//        throw new Error('error code requires an error response packet type');
//      }
//    } break;
//    case ATTRIBUTE.iceControlled.NAME: {
//      if ( packet.doc.attribute.iceControlling ) {
//        throw new Error('ice controlling is already present');
//      }
//    } break;
//    case ATTRIBUTE.iceControlling.NAME: {
//      if ( packet.doc.attribute.iceControlled ) {
//        throw new Error('ice controlled is already present');
//      }
//    } break;
//    case ATTRIBUTE.unknownAttributes.NAME: {
//      if ( !packet.doc.attribute.errorCode ) {
//        throw new Error('error code must be present');
//      }
//      else if ( packet.doc.attribute.errorCode.obj != 420 ) {
//        throw new Error('unknown attributes require 420 error code');
//      }
//    } break;
//  }
//}
