...
exports.encode = function encode ( packet, value ) {
  ...
  if ( !value ) return new Error('invalid alternate server');
...
exports.decode = function decode ( packet, value ) {
  ...
  switch ( value.readUInt8(1) ) {
    case 0x01: {
      if ( value.length != 8 ) return new Error('invalid alternate server');
    ...
    case 0x02: {
      if ( value.length != 20 ) return new Error('invalid alternate server');
    ...
    default: return new Error('invalid alternate server');
  }
